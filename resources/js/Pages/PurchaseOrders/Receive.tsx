...
export default function Receive({ purchaseOrder }: any) {
    ...
    return (
        <AppLayout header="Terima Barang">
            ...
            <div className="max-w-3xl bg-white rounded-xl shadow p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 mb-2">
                    <div>
                        <span className="font-medium text-gray-500">No. PO:</span>{' '}
                    ...
                    <div>
                        <span className="font-medium text-gray-500">Tgl PO:</span>{' '}
                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50 border-b">
                                <tr className="text-left text-gray-600">
                                    ...
                                    <th className="px-4 py-2 w-24 text-right">Qty PO</th>
                                    <th className="px-4 py-2 w-28 text-right">Sudah Diterima</th>
                                    <th className="px-4 py-2 w-32 text-right">Sisa</th>
                                    <th className="px-4 py-2 w-32">Terima Sekarang</th>
                                </tr>
                            </thead>
                                        ...
                                        <tr key={item.id} className={remaining <= 0 ? 'bg-gray-50 text-gray-400' : ''}>
                                            ...
                                            <td className="px-4 py-2">
                                                <input
                                                    ...
                                                    className="w-full rounded-md border border-gray-300 px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 disabled:bg-gray-100 disabled:cursor-not-allowed"
                                                />
                                            </td>
                                        </tr>
                                    );
